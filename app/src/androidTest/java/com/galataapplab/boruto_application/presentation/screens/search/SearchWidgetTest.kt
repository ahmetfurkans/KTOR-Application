...
import com.galataapplab.boruto_application.presentation.screens.search.components.SearchWidget
...
class SearchWidgetTest {
    ...
    fun openSearchWidget_addInputText_assertInputText() {
        ...
        composeTestRule.onNodeWithContentDescription("TextField")
            .performTextInput("Furkan")
        composeTestRule.onNodeWithContentDescription("TextField")
            .assertTextEquals("Furkan")
    }
